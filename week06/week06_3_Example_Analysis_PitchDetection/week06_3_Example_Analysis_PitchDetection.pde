...
SoundFile sound;// 新家這行 因為要把音樂讀近來
...
void setup() {
  ...
  sound.loop();
  pitchDetector = new PitchDetector(this);// 新增 amd 初始化
  // capture audio input
  //pitchDetector.input(new AudioIn(this, 0)); 原本城市適用audio In 音效卡的因緣輸入
